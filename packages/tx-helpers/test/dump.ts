import { bitcoin, scriptPkToAddress } from '@unisat/wallet-bitcoin'
import { expect } from 'vitest'

export async function expectThrowError(func: any, errorMsg: string) {
  let error
  try {
    await func()
  } catch (e) {
  ...
  expect((error as Error).message).to.eq(errorMsg)
}
